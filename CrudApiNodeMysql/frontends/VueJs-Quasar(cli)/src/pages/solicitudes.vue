        ...
        <section class="data">
          <div class="row">
            <table>
                ...
                <tbody>
                    <tr v-for="(item, key) in solicitudes"
                        :key="key">
                        <td>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      methods: {
        ...mapActions('store', ['Editar', 'Borrar', 'Add']),
        editar (item, key) {
          var formData = {}
        ...
        editarPhp (item, key) {
          ...
          this.formActualizar = false;
                    ...
                    verFormActualizar (item) {
                        ...
                        this.nombreActualizar = this.solicitudes[item].nombre;
                        this.profesionActualizar = this.solicitudes[item].profesion;
                        this.rangoActualizar = this.solicitudes[item].rango;
